...
print('DatumEndgueltigeStilllegung')
...
print('capacity Land 2017: {} GW, capacity See 2017: {}GW'.format(
    round(cap_land, 2), round(cap_see, 2)))
...
print('capacity Land 2017, decom 20: {} GW, capacity See 2017, decom 20: {} GW'.format(
    round(cap_land_20, 2), round(cap_see_20, 2)))

# installed cap 50 hz
cap_50hz = f.get_50hz_capacity(year=year, category='Wind') / 1e6
print('Installed capacity 50 Hertz {} GW'.format(cap_50hz))