...
def get_weather_data_germany(year, weather_data_name, format_, path):
    ...
    """
    # pickle load and dump for faster debugging - todo: delete - or do not push
    pickle_filename = os.path.join(os.path.dirname(__file__), 'data/dumps',
                            'weather_{}_{}.p'.format(weather_data_name, year))
    try:
